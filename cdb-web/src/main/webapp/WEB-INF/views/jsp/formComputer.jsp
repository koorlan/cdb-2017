                ...
                <form:form class="form-horizontal" method="post"
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <c:choose>
                                <c:when test="${computerForm['new']}">
                                    <button type="submit" class="btn btn-primary pull-right"><spring:message code="cdb.form.add" /></button>
                                </c:when>
                                <c:otherwise>
                                    <button type="submit" class="btn btn-primary pull-right"><spring:message code="cdb.form.update" /></button>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
